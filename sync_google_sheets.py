...
def build_inventory_rows(workbook: Any) -> list[list[Any]]:
    ...
    for row in inventory_records:
        ...
        item["Total kg"] += to_number(row.get("Equivalente en kg"))
...
def build_dispatch_rows(workbook: Any) -> list[list[Any]]:
    ...
    for detail in detail_records:
        ...
        date_time_text = f"{date_text} {time_text}".strip()
        ...
        output_rows.append(
            [
                ...
                to_number(detail.get("Total kg despachado")),
                clean_text(header.get("Responsable")),
                clean_text(header.get("Observacion")),
            ]
        )
